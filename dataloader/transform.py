...
def build_transformer(image_size=(416, 416)):
    ...
    transformers['train'] = album.Compose([
        album.ShiftScaleRotate(rotate_limit=20, border_mode=cv2.BORDER_CONSTANT, value=(127,127,127), p=0.5),
        ...
        ToTensorV2()],
        bbox_params=album.BboxParams(format='yolo', min_area=10, min_visibility=0.01 ,label_fields=['class_ids']),
    )
